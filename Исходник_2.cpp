...
struct Amulet:public Predmet
{
	void use(Person &a) {
		a.health += 5;
		cout << "Вы увеличили здоровье " << a.fraction << endl;
	}
};
...
struct Yad:public Predmet
{
	void use(Person &a) {
		a.health -= 4;
		cout << "Вы уменьшили здоровье " << a.fraction << endl;
	}
};
...
struct Eleksir:public Predmet
{
	void use(Person &a) {
		a.damage +=1;
		cout << "Вы повысили урон " << a.fraction << endl;
	}
};
...
struct Proklyatie:public Predmet
{
	void use(Person &a) {
		a.damage -= 1;
		cout << "Вы понизили урон " << a.fraction << endl;
	}
};
    ...
    while(1) {
        if(turn == 1) { // ход пользователя
            ...
            if(choice == 1) {
                ...
                if(choice_2 == 4 && b2.size() == 1) {
                    choice_2 = 3;
                }
                if(choice_2 == 6 && c2.size() == 1) {
                    choice_2 = 5;
                }
                if((choice_2 == 1 || choice_2 == 2) && a2.empty()) {
                    cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
                }
                if((choice_2 == 3 || choice_2 == 4) && b2.empty()) {
                    cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
                }
                if((choice_2 == 5 || choice_2 == 6) && c2.empty()) {
                    cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
                }
                else if(choice_2 == 1) {
                    a1[0]->attack(*a2[0]);
                ...
                if(b1[0]->name == "Стрелок") {
					...
					if(choice_2_1 == choice_2_2 || choice_2_1 == choice_2_3 ||choice_2_2 == choice_2_3 || choice_2_1 >= choice_2_2 || choice_2_1 >= choice_2_3 || choice_2_2 >= choice_2_3) {
						...
						if(choice_2_1 == 4 && b2.size() == 1) {
							choice_2_1 = 3;
						}
						if(choice_2_1 == 6 && c2.size() == 1) {
							choice_2_1 = 5;
						}
						if((choice_2_1 == 1 || choice_2_1 == 2) && a2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((choice_2_1 == 3 || choice_2_1 == 4) && b2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((choice_2_1 == 5 || choice_2_1 == 6) && c2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if(choice_2_2 == 2 && a2.size() == 1) {
							choice_2_2 = 1;
						}
						if(choice_2_2 == 4 && b2.size() == 1) {
							choice_2_2 = 3;
						}
						if(choice_2_2 == 6 && c2.size() == 1) {
							choice_2_2 = 5;
						}
						if((choice_2_2 == 1 || choice_2_2 == 2) && a2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((choice_2_2 == 3 || choice_2_2 == 4) && b2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((choice_2_2 == 5 || choice_2_2 == 6) && c2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if(choice_2_3 == 2 && a2.size() == 1) {
							choice_2_3 = 1;
						}
						if(choice_2_3 == 4 && b2.size() == 1) {
							choice_2_3 = 3;
						}
						if(choice_2_3 == 6 && c2.size() == 1) {
							choice_2_3 = 5;
						}
						if((choice_2_3 == 1 || choice_2_3 == 2) && a2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((choice_2_3 == 3 || choice_2_3 == 4) && b2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((choice_2_3 == 5 || choice_2_3 == 6) && c2.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
							...
							if(choice_2_2 == 2) {
								if(choice_2_3 == 3) {
									...
									if(a2[0]->health <= 0 || a2[1]->health <= 0 || b2[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 4) {
									b1[0]->attack(*a2[0],*a2[1],*b2[1]);
									if(a2[0]->health <= 0 || a2[1]->health <= 0 || b2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 5) {
									b1[0]->attack(*a2[0],*a2[1],*c2[0]);
									if(a2[0]->health <= 0 || a2[1]->health <= 0 || c2[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 6) {
									b1[0]->attack(*a2[0],*a2[1],*c2[1]);
									if(a2[0]->health <= 0 || a2[1]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(choice_2_3 == 4) {
									...
									if(a2[0]->health <= 0 || b2[0]->health <= 0 || b2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 5) {
									b1[0]->attack(*a2[0],*b2[0],*c2[0]);
									if(a2[0]->health <= 0 || b2[0]->health <= 0 || c2[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 6) {
									b1[0]->attack(*a2[0],*b2[0],*c2[1]);
									if(a2[0]->health <= 0 || b2[0]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(choice_2_3 == 5) {
									...
									if(a2[0]->health <= 0 || b2[1]->health <= 0 || c2[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 6) {
									b1[0]->attack(*a2[0],*b2[1],*c2[1]);
									if(a2[0]->health <= 0 || b2[1]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(choice_2_3 == 6) {
									...
									if(a2[0]->health <= 0 || c2[0]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
							...
							if(choice_2_2 == 3) {
								if(choice_2_3 == 4) {
									...
									if(a2[1]->health <= 0 || b2[0]->health <= 0 || b2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 5) {
									b1[0]->attack(*a2[1],*b2[0],*c2[0]);
									if(a2[1]->health <= 0 || b2[0]->health <= 0 || c2[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 6) {
									b1[0]->attack(*a2[1],*b2[0],*c2[1]);
									if(a2[1]->health <= 0 || b2[0]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(choice_2_3 == 5) {
									...
									if(a2[1]->health <= 0 || b2[1]->health <= 0 || c2[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 6) {
									b1[0]->attack(*a2[1],*b2[1],*c2[1]);
									if(a2[1]->health <= 0 || b2[1]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(choice_2_3 == 6) {
									...
									if(a2[1]->health <= 0 || c2[0]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
							...
							if(choice_2_2 == 4) {
								if(choice_2_3 == 5) {
									...
									if(b2[0]->health <= 0 || b2[1]->health <= 0 || c2[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(choice_2_3 == 6) {
									b1[0]->attack(*b2[0],*b2[1],*c2[1]);
									if(b2[0]->health <= 0 || b2[1]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(choice_2_3 == 6) {
									...
									if(b2[0]->health <= 0 || c2[0]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
							...
							if(choice_2_2 == 5) {
								if(choice_2_3 == 6) {
									...
									if(b2[1]->health <= 0 || c2[0]->health <= 0 || c2[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
					...
					if(choice_2_1 == choice_2_2 || choice_2_1 >= choice_2_2) {
						...
						if((choice_2_2 == 5 || choice_2_2 == 6) && c2.empty()) {
							...
							if(choice_2_2 == 2) {
								...
								if(a2[0]->health <= 0 || a2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 3) {
								c1[0]->attack(*a2[0],*b2[0]);
								if(a2[0]->health <= 0 || b2[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 4) {
								c1[0]->attack(*a2[0],*b2[1]);
								if(a2[0]->health <= 0 || b2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 5) {
								c1[0]->attack(*a2[0],*c2[0]);
								if(a2[0]->health <= 0 || c2[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 6) {
								c1[0]->attack(*a2[0],*c2[1]);
								if(a2[0]->health <= 0 || c2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
						}
							...
							if(choice_2_2 == 3) {
								...
								if(a2[1]->health <= 0 || b2[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 4) {
								c1[0]->attack(*a2[1],*b2[1]);
								if(a2[1]->health <= 0 || b2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 5) {
								c1[0]->attack(*a2[1],*c2[0]);
								if(a2[1]->health <= 0 || c2[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 5) {
								c1[0]->attack(*a2[1],*c2[1]);
								if(a2[1]->health <= 0 || c2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
						}
							...
							if(choice_2_2 == 4) {
								...
								if(b2[0]->health <= 0 || b2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 5) {
								c1[0]->attack(*b2[0],*c2[1]);
								if(b2[0]->health <= 0 || c2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 6) {
							...
							if(choice_2_2 == 5) {
								...
								if(b2[1]->health <= 0 || c2[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(choice_2_2 == 6) {
								c1[0]->attack(*b2[1],*c2[1]);
								if(b2[1]->health <= 0 || c2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
						}
							...
							if(choice_2_2 == 6) {
								...
								if(c2[0]->health <= 0 || c2[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
						}
            ...
            // cout << "Хотите ли вы использовать какой-нибудь предмет?" << endl;
            // int choice_3;
            // if(choice_3 == 1) {
            //     cout << "Выберите цель для предмета";
            //     amulet_1.use(*a1[0]);
            // }
        ...
        if(turn == -1) { // ход компьютера
            ...
            if((compChoice == 0 || compChoice == 1) && a2.size() == 1) {
                compChoice = 0;
            } 
            if((compChoice == 0 || compChoice == 1) && a2.empty()) {
                cout << "Компьютер не справился с выбором!" << endl;
            }
            else if(compChoice == 0 || compChoice == 1) {
                cout << "Компьютер выбрал карту " << a2[compChoice]->name << endl;
            }
            ...
            if(compChoice == 0 || compChoice == 1) {
                ...
                if(a2.empty()) {
                    ...
                    a2[compChoice]->attack(*a1[0]);
                } else if (targetChoice == 2) {
                    a2[compChoice]->attack(*a1[1]);
                } else if (targetChoice == 3) {
                    a2[compChoice]->attack(*b1[0]);
                } else if (targetChoice == 4) {
                    a2[compChoice]->attack(*b1[1]);
                } else if (targetChoice == 5) {
                    a2[compChoice]->attack(*c1[0]);
                } else if (targetChoice == 6) {
                    a2[compChoice]->attack(*c1[1]);
                } else {
                    cout << "Компьютер растерялся и пропустил ход!" << endl;
                }            
            }*/
            ...
            if(compChoice == 1) {
                ...
                if(targetChoice == 4 && b1.size() == 1) {
                    targetChoice = 3;
                }
                if(targetChoice == 6 && c1.size() == 1) {
                    targetChoice = 5;
                }
                if((targetChoice == 1 || targetChoice == 2) && a1.empty()) {
                    cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
                }
                if((targetChoice == 3 || targetChoice == 4) && b1.empty()) {
                    cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
                }
                if((targetChoice == 5 || targetChoice == 6) && c1.empty()) {
                    cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
                }
                else if(targetChoice == 1) {
                    a2[0]->attack(*a1[0]);
                ...
                if(b2[0]->name == "Стрелок") {
					...
					if(targetChoise_1 == targetChoise_2 || targetChoise_1 == targetChoise_3 ||targetChoise_2 == targetChoise_3 || targetChoise_1 >= targetChoise_2 || targetChoise_1 >= targetChoise_3 || targetChoise_2 >= targetChoise_3) {
						...
						if(targetChoise_1 == 4 && b1.size() == 1) {
							targetChoise_1 = 3;
						}
						if(targetChoise_1 == 6 && c1.size() == 1) {
							targetChoise_1 = 5;
						}
						if((targetChoise_1 == 1 || targetChoise_1 == 2) && a1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((targetChoise_1 == 3 || targetChoise_1 == 4) && b1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((targetChoise_1 == 5 || targetChoise_1 == 6) && c1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if(targetChoise_2 == 2 && a1.size() == 1) {
							targetChoise_2 = 1;
						}
						if(targetChoise_2 == 4 && b1.size() == 1) {
							targetChoise_2 = 3;
						}
						if(targetChoise_2 == 6 && c1.size() == 1) {
							targetChoise_2 = 5;
						}
						if((targetChoise_2 == 1 || targetChoise_2 == 2) && a1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((targetChoise_2 == 3 || targetChoise_2 == 4) && b1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((targetChoise_2 == 5 || targetChoise_2 == 6) && c1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if(targetChoise_3 == 2 && a1.size() == 1) {
							targetChoise_3 = 1;
						}
						if(targetChoise_3 == 4 && b1.size() == 1) {
							targetChoise_3 = 3;
						}
						if(targetChoise_3 == 6 && c1.size() == 1) {
							targetChoise_3 = 5;
						}
						if((targetChoise_3 == 1 || targetChoise_3 == 2) && a1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((targetChoise_3 == 3 || targetChoise_3 == 4) && b1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
						if((targetChoise_3 == 5 || targetChoise_3 == 6) && c1.empty()) {
							cout << "Бойцов больше нет. Бить лежачих - это аморально!" << endl;
						}
							...
							if(targetChoise_2 == 2) {
								if(targetChoise_3 == 3) {
									...
									if(a1[0]->health <= 0 || a1[1]->health <= 0 || b1[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 4) {
									b2[0]->attack(*a1[0],*a1[1],*b1[1]);
									if(a1[0]->health <= 0 || a1[1]->health <= 0 || b1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 5) {
									b2[0]->attack(*a1[0],*a1[1],*c1[0]);
									if(a1[0]->health <= 0 || a1[1]->health <= 0 || c1[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 6) {
									b2[0]->attack(*a1[0],*a1[1],*c1[1]);
									if(a1[0]->health <= 0 || a1[1]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(targetChoise_3 == 4) {
									...
									if(a1[0]->health <= 0 || b1[0]->health <= 0 || b1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 5) {
									b2[0]->attack(*a1[0],*b1[0],*c1[0]);
									if(a1[0]->health <= 0 || b1[0]->health <= 0 || c1[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 6) {
									b2[0]->attack(*a1[0],*b1[0],*c1[1]);
									if(a1[0]->health <= 0 || b1[0]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(targetChoise_3 == 5) {
									...
									if(a1[0]->health <= 0 || b1[1]->health <= 0 || c1[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 6) {
									b2[0]->attack(*a1[0],*b1[1],*c1[1]);
									if(a1[0]->health <= 0 || b1[1]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(targetChoise_3 == 6) {
									...
									if(a1[0]->health <= 0 || c1[0]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
							...
							if(targetChoise_2 == 3) {
								if(targetChoise_3 == 4) {
									...
									if(a1[1]->health <= 0 || b1[0]->health <= 0 || b1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 5) {
									b2[0]->attack(*a1[1],*b1[0],*c1[0]);
									if(a1[1]->health <= 0 || b1[0]->health <= 0 || c1[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 6) {
									b2[0]->attack(*a1[1],*b1[0],*c1[1]);
									if(a1[1]->health <= 0 || b1[0]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(targetChoise_3 == 5) {
									...
									if(a1[1]->health <= 0 || b1[1]->health <= 0 || c1[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 6) {
									b2[0]->attack(*a1[1],*b1[1],*c1[1]);
									if(a1[1]->health <= 0 || b1[1]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(targetChoise_3 == 6) {
									...
									if(a1[1]->health <= 0 || c1[0]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
							...
							if(targetChoise_2 == 4) {
								if(targetChoise_3 == 5) {
									...
									if(b1[0]->health <= 0 || b1[1]->health <= 0 || c1[0]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
								else if(targetChoise_3 == 6) {
									b2[0]->attack(*b1[0],*b1[1],*c1[1]);
									if(b1[0]->health <= 0 || b1[1]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
								...
								if(targetChoise_3 == 6) {
									...
									if(b1[0]->health <= 0 || c1[0]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
							...
							if(targetChoise_2 == 5) {
								if(targetChoise_3 == 6) {
									...
									if(b1[1]->health <= 0 || c1[0]->health <= 0 || c1[1]->health <= 0) {
										cout << "Противник убит!" << endl;
									}
								}
							}
					...
					if(targetChoise_1 == targetChoise_2 || targetChoise_1 >= targetChoise_2) {
						...
						if((targetChoise_2 == 5 || targetChoise_2 == 6) && c1.empty()) {
							...
							if(targetChoise_2 == 2) {
								...
								if(a1[0]->health <= 0 || a1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 3) {
								c2[0]->attack(*a1[0],*b1[0]);
								if(a1[0]->health <= 0 || b1[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 4) {
								c2[0]->attack(*a1[0],*b1[1]);
								if(a1[0]->health <= 0 || b1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 5) {
								c2[0]->attack(*a1[0],*c1[0]);
								if(a1[0]->health <= 0 || c1[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 6) {
								c2[0]->attack(*a1[0],*c1[1]);
								if(a1[0]->health <= 0 || c1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
						}
							...
							if(targetChoise_2 == 3) {
								...
								if(a1[1]->health <= 0 || b1[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 4) {
								c2[0]->attack(*a1[1],*b1[1]);
								if(a1[1]->health <= 0 || b1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 5) {
								c2[0]->attack(*a1[1],*c1[0]);
								if(a1[1]->health <= 0 || c1[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 5) {
								c2[0]->attack(*a1[1],*c1[1]);
								if(a1[1]->health <= 0 || c1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
						}
							...
							if(targetChoise_2 == 4) {
								...
								if(b1[0]->health <= 0 || b1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 5) {
								c2[0]->attack(*b1[0],*c1[1]);
								if(b1[0]->health <= 0 || c1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 6) {
							...
							if(targetChoise_2 == 5) {
								...
								if(b1[1]->health <= 0 || c1[0]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
							else if(targetChoise_2 == 6) {
								c2[0]->attack(*b1[1],*c1[1]);
								if(b1[1]->health <= 0 || c1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
						}
							...
							if(targetChoise_2 == 6) {
								...
								if(c1[0]->health <= 0 || c1[1]->health <= 0) {
									cout << "Противник убит!" << endl;
								}
							}
						}
        ...
        /*if(a2.empty()) {
            cout << "Все вражеские воины мертвы!" << endl;
        }
        if(b2.empty()) {
            cout << "Все вражеские лучники мертвы!" << endl;
        }
        if(c2.empty()) {
            cout << "Все вражеские маги мертвы!" << endl;
        }*/

        if(a2.empty() && b2.empty() && c2.empty()) {
